...
AGENT_ID = 14486  # Ganti sesuai Agent ID-mu

# =======================
# ABI MINIMAL UNTUK SUBMIT
# =======================
PROBLEM_MANAGER_ABI = [
    {
        "inputs": [
...
# =======================
# LOOP UTAMA DENGAN TRACKING
# =======================
last_problem_id = None

while True:
    problem = fetch_current_problem()
    if problem and problem["problem_id"] != last_problem_id:
